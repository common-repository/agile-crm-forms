(function() {
    tinymce.PluginManager.add('agilecrm_forms_button', function( editor, url ) {
        editor.addButton( 'agilecrm_forms_button', {
            text: 'Agile Forms',
            icon: false,
            onclick: function() {
            jQuery.ajax({
                ...
                editor.windowManager.open( {
                    ...
                    onsubmit: function( e ) {
                        editor.insertContent( '[agileform_forms id="' + e.data.form+ '"]');
                    }
                });
                }
            });
